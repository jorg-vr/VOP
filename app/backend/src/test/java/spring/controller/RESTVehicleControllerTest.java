...
public class RESTVehicleControllerTest {
    ...
    public static void setup() throws Exception {
        ...
        try {
            ...
            customer = new Customer(address, "04789456123", "customerName", "custBTW", Periodicity.QUARTERLY, Periodicity.QUARTERLY);
            ...
            fleet = new Fleet("fleetName",customer,address);
    ...
    public void get() throws Exception {
        ...
        Vehicle vehicle = vehicleDAO.create(new Vehicle("brand 1", "model A", "UZ0UZABCUKZ12345L", "ABC 123", 30000, 2500, vehicleType, localDate, fleet, null));
    ...
    public void post() throws Exception {
        ...
        RESTVehicle restVehicle = new RESTVehicle(new Vehicle("brand 1", "model A", "UZ0UZABCUKZ12345L", "ABC 123", 30000, 2500, vehicleType, localDate, fleet, null));
        ...
        try {
            ...
            assertEquals("fleet field not created correctly", fleet, vehicle.getFleet());
    ...
    public void putId() throws Exception {
        ...
        try {
            ...
            assertEquals("fleet field not updated correctly", fleet, vehicle1.getFleet());
            //Clean up database for other tests
            vehicleDAO.remove(vehicle.getUuid());
        } catch (DataAccessException e) {
