...
public class ProductionVehicleDAOFiltersTest {
    ...
    public static void initProvider() throws Exception {
        ...
        customer = createCustomer(new Customer(address, "123", "customer 1", "456"));
        address = new Address("streettest n1", "59", "town 1", "9999", "country 1");
        fleet1 = createFleet(new Fleet("name 1", customer, address));
        address = new Address("streettest n1", "59", "town 1", "9999", "country 1");
        fleet2 = createFleet(new Fleet("name 2", customer, address));

        v1 = createVehicle(new Vehicle("brand 1", "model 1", "AAAAAAAAAAAAAAAAA", "ABC-123", 500, 3000, vehicleType1, LocalDate.of(2016, 7, 15), fleet1));
        v2 = createVehicle(new Vehicle("brand 1", "model 2", "BBBBBBBBBBBBBBBBB", "DEF-123", 1000, 3500, vehicleType2, LocalDate.of(2016, 7, 26), fleet2));
        v3 = createVehicle(new Vehicle("brand 2", "model 2", "CCCCCCCCCCCCCCCCC", "DEF-456", 1500, 4000, vehicleType1, LocalDate.of(2016, 9, 26), fleet2));
    }
    ...
    public static void closeProvider() throws Exception {
        ...
        removeVehicle(v1.getUuid());
        removeVehicle(v2.getUuid());
        removeVehicle(v3.getUuid());
        removeFleet(fleet1.getUuid());
        removeFleet(fleet2.getUuid());
    ...
    public void multipleFilters() throws Exception {
        Vehicle v4 = createVehicle(new Vehicle("brand 1", "model 2", "FAAAAAAAAAAAAAAAA", "ABC-123", 500, 4000, vehicleType2, LocalDate.of(2016, 9, 28), fleet2));
        Vehicle v5 = createVehicle(new Vehicle("brand 2", "model 1", "FBBBBBBBBBBBBBBBB", "DEF-123", 1000, 4500, vehicleType1, LocalDate.of(2017, 7, 26), fleet1));
        Vehicle v6 = createVehicle(new Vehicle("brand 1", "model 2", "FCCCCCCCCCCCCCCCC", "DEF-456", 1500, 5000, vehicleType2, LocalDate.of(2017, 9, 26), fleet1));
        ...
        removeVehicle(v4.getUuid());
        removeVehicle(v5.getUuid());
        removeVehicle(v6.getUuid());
    }
