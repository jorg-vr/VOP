...
public class ProductionVehicleDAOFiltersTestTest {
    ...
    public void byBrand() throws Exception {
        ...
        assertTrue("byBrand filter werkt niet", c1.contains(v1) & c1.contains(v2) & (c1.size() == 2));
        assertTrue("byBrand filter werkt niet", c2.contains(v3) & (c2.size() == 1));
    }
    ...
    public void byModel() throws Exception {
        ...
        assertTrue("byModel filter werkt niet", c1.contains(v1) & (c1.size() == 1));
        assertTrue("byModel filter werkt niet", c2.contains(v2) & c2.contains(v3) & (c2.size() == 2));
    }
    ...
    public void byLicensePlate() throws Exception {
        ...
        assertTrue("byLicensePlate filter werkt niet", c1.contains(v1) & (c1.size() == 1));
        assertTrue("byLicensePlate filter werkt niet", c2.contains(v3) & (c2.size() == 1));
    }
    ...
    public void atProductionDate() throws Exception {
        ...
        assertTrue("atProductionDate filter werkt niet", c1.contains(v1) & (c1.size() == 1));
        assertTrue("atProductionDate filter werkt niet", c2.contains(v3) & (c2.size() == 1));
    }
    ...
    public void beforeProductionDate() throws Exception {
        ...
        assertTrue("beforeProductionDate filter werkt niet", c1.contains(v1) & c1.contains(v2) & (c1.size() == 2));
        assertTrue("beforeProductionDate filter werkt niet", c2.size() == 3);
    }
    ...
    public void afterProductionDate() throws Exception {
        ...
        assertTrue("afterProductionDate filter werkt niet", c1.contains(v2) & c1.contains(v3) & (c1.size() == 2));
        assertTrue("afterProductionDate filter werkt niet", c2.size() == 0);
    }
    ...
    public void atLeastMileage() throws Exception {
        ...
        assertTrue("atLeastMileage filter werkt niet", c1.contains(v2) & c1.contains(v3) & (c1.size() == 2));
        assertTrue("atLeastMileage filter werkt niet", c2.size() == 0);
    }
    ...
    public void maxMileage() throws Exception {
        ...
        assertTrue("maxMileage filter werkt niet", c2.size() == 3);
    }
    ...
    public void byType() throws Exception {
        ...
        assertTrue("byType filter werkt niet", c1.contains(v1) & c1.contains(v3) & (c1.size() == 2));
        assertTrue("byType filter werkt niet", c2.contains(v2) & (c2.size() == 1));
    }
    ...
    public void multipleFilters() throws Exception {
        ...
        assertTrue("Applying multiple filters simultaneously doesn't work correctly", c1.contains(v1) & c1.contains(v5) & (c1.size() == 2));
        assertTrue("Applying multiple filters simultaneously doesn't work correctly", c2.contains(v2) & (c2.size() == 1));
        assertTrue("Applying multiple filters simultaneously doesn't work correctly", c3.contains(v3) & (c3.size() == 1));
