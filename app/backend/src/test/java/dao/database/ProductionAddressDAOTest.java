...
public class ProductionAddressDAOTest {
    ...
    public void createGetRemoveTest() throws Exception {
        ...
        try {
            Address a2 = getAddress(a1.getUuid());
    ...
    public void update() throws Exception {
        Address a1 = createAddress(new Address("streettest n1", "59", "town 1", "9999", "country 1"));
        ...
        Address a3 = getAddress(a1.getUuid());
