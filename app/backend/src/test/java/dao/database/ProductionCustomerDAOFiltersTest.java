...
public class ProductionCustomerDAOFiltersTest {
    ...
    public static void init() throws Exception {
        ...
        v1 = customerDAO.create(new Customer(a1, "Email@address1.com", "911", "customername 1", "btw123", "123456789", CompanyType.TYPE1));
        v2 = customerDAO.create(new Customer(a1, "Email@address2.com", "911", "customername 2", "btw123", "123456781", CompanyType.TYPE1));
        v3 = customerDAO.create(new Customer(a2, "Email@address2.com", "912", "customername 2", "btw124", "123456781", CompanyType.TYPE2));
    }
