...
public class FunctionController extends AbstractController<Function> {
    ...
    public Function update(UUID functionId, LocalDateTime endDate) throws DataAccessException {
        return functionDAO.update(functionId, endDate);
    }
}
